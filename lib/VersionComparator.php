...
class VersionComparator {
    ...
    static function compare(Version $version1, Version $version2) {
...
interface VersionRangeOperatorInterface {
     ...
     * @return boolean
     */
    function compare(Version $value);
}
...
class versionRangeUnaryOperator implements VersionRangeOperatorInterface {
     ...
     */
    function __construct($operator, Version $version) {
        $this->op = $operator;
